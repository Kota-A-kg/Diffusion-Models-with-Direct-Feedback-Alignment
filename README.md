...
## Acknowledgements
This project is built upon the following original works by [keiji-miura](https://github.com/keiji-miura):

* [minDiffusionModel](https://github.com/keiji-miura/minDiffusionModel) - Minimum diffusion model for MNIST
* [FA-based_CNN_Autoencoder](https://github.com/keiji-miura/FA-based_CNN_Autoencoder) - FA function implementation
